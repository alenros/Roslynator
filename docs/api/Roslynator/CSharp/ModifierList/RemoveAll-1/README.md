...
```csharp
public static TNode RemoveAll<TNode>(TNode node, System.Func<Microsoft.CodeAnalysis.SyntaxToken, bool> predicate) where TNode : Microsoft.CodeAnalysis.SyntaxNode
```
